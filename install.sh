...
PUBLIC_BASE_URL_GH="${QWDTT_PUBLIC_BASE_URL_GH-https://raw.githubusercontent.com/JinComputers/meridian-dist/$GH_BRANCH}"
...
die() {
	...
	echo "[meridian]   3. если на роутере уже стоял qwdtt, он остался в прежнем виде." >&2
	exit 1
}
...
setup_config() {
	...
	PEER="${PEER:-${VSHITO_PEER:-138.124.78.252:56000}}"
